...
/// </summary>
public abstract class Performance_Widget_Base : BarWidgetBase {
    ...
    protected virtual void Update() {
        _text = GetText(_counter.NextValue()).Trim();
        MarkDirty();
    }

    public override IBarWidgetPart[] GetParts() {
        // return Parts(Part(string.Format(StringFormat, _text), null, null, ClickAction));
        return Parts(Part(LeftPadding + _text + RightPadding, fore:ForeColor, back: BackColor, partClicked: ClickAction, fontname: FontName));
    }
...
/// </summary>
public class Cpu_Performance_Widget : Performance_Widget_Base {
...
/// </summary>
public class Memory_Performance_Widget : Performance_Widget_Base {
...
/// </summary>
public class Network_Performance_Widget : Performance_Widget_Base {
    ...
    public Network_Performance_Widget(string interfaceName = null) : base() {
