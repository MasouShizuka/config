                            ...
                            if SelectableFrame::new(false)
                                .show(ui, |ui| {
                                    ...
                                    if let DisplayFormat::Text | DisplayFormat::IconAndText = format
                                    {
                                        ...
                                        let title_rich = if container_i == komorebi_notification_state.focused_container_idx && i == focused_window_idx {
                                            RichText::new(title)
...
pub struct KomorebiNotificationState {
    pub workspaces: Vec<(String, bool, KomorebiNotificationStateContainerInformation)>,
