...
impl Network {
    ...
    fn network_activity(&mut self) -> (Vec<NetworkReading>, Vec<NetworkReading>) {
            ...
            > Duration::from_secs(self.data_refresh_interval)
        {
            ...
            for (_, data) in &self.networks_network_activity {
            ...
            if self.show_activity {
                activity.push(NetworkReading::new(
                    ...
                    ReadingValue::from(Self::to_pretty_bytes(
                        received,
            ...
            if self.show_total_activity {
                total_activity.push(NetworkReading::new(
                    ...
                    ReadingValue::from(Self::to_pretty_bytes(total_received, 1)),
                    ReadingValue::from(Self::to_pretty_bytes(total_transmitted, 1)),
                ))
            }
