...
BOOL RegisterAllHotKey(HWND hWnd, bool exclude_toggle) {
	...
	return (
		...
		RegCustomHotKey(hWnd, "selectModeDouble") &&
		RegCustomHotKey(hWnd, "fastSelectMode") &&
		RegCustomHotKey(hWnd, "hintModeSingle") &&
		RegCustomHotKey(hWnd, "hintModeDouble") &&
		RegCustomHotKey(hWnd, "fastHintMode")
		);
}
BOOL RegisterTagHotKey(HWND hWnd) {
	return (
		...
		RegCustomHotKey(hWnd, "doubleClickPrefix") &&
...
BOOL UnregisterAllHotKey(HWND hWnd, bool exclude_toggle) {
	...
	return (
		...
		UnregCustomHotKey(hWnd, "selectModeDouble") &&
		UnregCustomHotKey(hWnd, "fastSelectMode") &&
		UnregCustomHotKey(hWnd, "hintModeSingle") &&
		UnregCustomHotKey(hWnd, "hintModeDouble") &&
		UnregCustomHotKey(hWnd, "fastHintMode")
		);
}
BOOL UnregisterTagHotKey(HWND hWnd) {
	return (
		...
		UnregCustomHotKey(hWnd, "doubleClickPrefix") &&
