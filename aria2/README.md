...
| aria2.conf           | `$HOME/.config/aria2/` | aria2 配置文件                                                                                                                                                                                   |
| aria2.sh             | `$HOME/.config/aria2/` | aria2 启动脚本                                                                                                                                                                                   |
| script.conf          | `$HOME/.config/aria2/` | aria2 附加功能脚本配置文件。                                                                                                                                                                     |
| core                 | `$HOME/.config/aria2/` | aria2 附加功能脚本核心文件。所有脚本都依赖于此文件运行。                                                                                                                                         |
...
| AriaNg.ico           | `$HOME/.config/aria2/` | aria2 图标                                                                                                                                                                                       |
