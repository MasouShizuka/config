...
function Menu:enable_key_bindings()
	...
	-- │ modified │
	-- ╰──────────╯
	local modifiable_keys = {'up+', 'k+', 'down+', 'j+', 'left', 'h', 'right', 'l', 'enter', 'kp_enter', 'bs', 'tab', 'esc', 'pgup+',
		'pgdwn+', 'home', 'end', 'del'}
...
function Menu:handle_shortcut(shortcut, info)
	...
	elseif id == 'enter' and menu.search and menu.search_debounce == 'submit' then
		self:search_submit()
	elseif id == 'up' or id == 'down' or id == 'j' or id == 'k' then
		self:navigate_by_offset((id == 'up' or id == 'k') and -1 or 1, true)
