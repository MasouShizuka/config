...
function Controls:init()
	...
	local shorthands = {
		...
		['pl-prev']        = 'command:navigate_before:playlist-prev?上一个',
		['pl-next']        = 'command:navigate_next:playlist-next?下一个',
		border             = 'toggle:border_style:border?窗口边框',
		ontop              = 'cycle:move_up:ontop:no/yes!?置顶',
		hwdec              = 'cycle:developer_board_off:hwdec:no=developer_board_off/yes=memory/auto-copy=developer_board?硬解',
		unscaled           = 'cycle:fit_screen:video-unscaled:no/yes!?原始尺寸',
